...
#define GPS_AON_TOP_DSLEEP_CTL_DIS_HW_RST_CNT_ADDR             GPS_AON_TOP_DSLEEP_CTL_ADDR
#define GPS_AON_TOP_DSLEEP_CTL_DIS_HW_RST_CNT_MASK             0x00000010
#define GPS_AON_TOP_DSLEEP_CTL_DIS_HW_RST_CNT_SHFT             4
