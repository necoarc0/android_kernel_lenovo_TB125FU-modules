 ...
 */
#ifndef __CONN_PTA_REGS_H__
#define __CONN_PTA_REGS_H__

#define CONN_PTA_BASE                                          0x1800C000

#define CONN_PTA_WFSET_PTA_CTRL_ADDR                           (CONN_PTA_BASE + 0x000)
#define CONN_PTA_PTA_CLK_CFG_ADDR                              (CONN_PTA_BASE + 0x004)
#define CONN_PTA_BTSET_PTA_CTRL_ADDR                           (CONN_PTA_BASE + 0x008)
#define CONN_PTA_RO_PTA_CTRL_ADDR                              (CONN_PTA_BASE + 0x00C)
#define CONN_PTA_TMR_CTRL_1_ADDR                               (CONN_PTA_BASE + 0x2C4)
#define CONN_PTA_TMR_CTRL_3_ADDR                               (CONN_PTA_BASE + 0x2CC)
#define CONN_PTA_GPS_BLANK_CFG_ADDR                            (CONN_PTA_BASE + 0x240)

#define CONN_PTA6_WFSET_PTA_CTRL_r_wfset_uart_apb_hw_en_ADDR   CONN_PTA_WFSET_PTA_CTRL_ADDR
...
#define CONN_PTA6_WFSET_PTA_CTRL_r_wfset_lte_pta_en_ADDR       CONN_PTA_WFSET_PTA_CTRL_ADDR
...
#define CONN_PTA6_WFSET_PTA_CTRL_r_wfset_en_pta_arb_ADDR       CONN_PTA_WFSET_PTA_CTRL_ADDR
...
#define CONN_PTA6_WFSET_PTA_CTRL_r_wfset_pta_en_ADDR           CONN_PTA_WFSET_PTA_CTRL_ADDR
#define CONN_PTA6_WFSET_PTA_CTRL_r_wfset_pta_en_MASK           0x00000001
#define CONN_PTA6_WFSET_PTA_CTRL_r_wfset_pta_en_SHFT           0

#define CONN_PTA6_PTA_CLK_CFG_r_pta_1m_cnt_ADDR                CONN_PTA_PTA_CLK_CFG_ADDR
#define CONN_PTA6_PTA_CLK_CFG_r_pta_1m_cnt_MASK                0x000000FF
#define CONN_PTA6_PTA_CLK_CFG_r_pta_1m_cnt_SHFT                0

#define CONN_PTA6_BTSET_PTA_CTRL_r_btset_uart_apb_hw_en_ADDR   CONN_PTA_BTSET_PTA_CTRL_ADDR
...
#define CONN_PTA6_TMR_CTRL_3_r_gps_l1_blank_tmr_thld_ADDR      CONN_PTA_TMR_CTRL_3_ADDR
...
#define CONN_PTA6_GPS_BLANK_CFG_r_idc_gps_l5_blank_src_ADDR    CONN_PTA_GPS_BLANK_CFG_ADDR
...
#define CONN_PTA6_GPS_BLANK_CFG_r_idc_gps_l1_blank_src_ADDR    CONN_PTA_GPS_BLANK_CFG_ADDR
...
#define CONN_PTA6_GPS_BLANK_CFG_r_gps_blank_src_ADDR           CONN_PTA_GPS_BLANK_CFG_ADDR
