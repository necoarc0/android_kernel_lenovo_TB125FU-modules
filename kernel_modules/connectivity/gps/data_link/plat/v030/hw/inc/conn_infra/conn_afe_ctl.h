...
#define CONN_AFE_CTL_BASE                                       0x18003000

#define CONN_AFE_CTL_RG_DIG_EN_03_ADDR                         (CONN_AFE_CTL_BASE + 0x008)

#define CONN_AFE_CTL_RG_DIG_EN_03_RG_WBG_EN_BPLL_UP_ADDR       CONN_AFE_CTL_RG_DIG_EN_03_ADDR
#define CONN_AFE_CTL_RG_DIG_EN_03_RG_WBG_EN_BPLL_UP_MASK       0x00200000
