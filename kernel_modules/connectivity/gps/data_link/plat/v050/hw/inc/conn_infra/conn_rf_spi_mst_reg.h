...
#define CONN_RF_SPI_MST_ADDR_SPI_GPS_ADDR_ADDR                 (CONN_RF_SPI_MST_REG_BASE + 0x0040)
#define CONN_RF_SPI_MST_ADDR_SPI_GPS_WDAT_ADDR                 (CONN_RF_SPI_MST_REG_BASE + 0x0044)
#define CONN_RF_SPI_MST_ADDR_SPI_GPS_RDAT_ADDR                 (CONN_RF_SPI_MST_REG_BASE + 0x0048)
